...
--config=experimental/largesensormodels/scenic/configs/participant_data_count_sweep/mae_lsm_base.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_tier2_base_10_5_res_participant_count_sweep \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/participant_data_count_sweep/mae_lsm_base.py:runlocal
"""
...
# 1) Dataset variables.
DATASET_NAMES = [
    'lsm_prod/lsm_300min_pretraining_100_n10_unshuffled',
    'lsm_prod/lsm_300min_pretraining_1K_n10_unshuffled',
    'lsm_prod/lsm_300min_pretraining_10K_n10_unshuffled',
    'lsm_prod/lsm_300min_pretraining_75K_n10_unshuffled'
]
...
def get_config(runlocal=''):
  ...
  config.experiment_name = 'electrodes-mae-participant_count_data_sweep'
  config.shuffle_seed = SHUFFLE_SEED

  # Dataset.
  config.data_dtype_str = 'float32'
  config.dataset_configs = ml_collections.ConfigDict()
  config.dataset_configs.dataset = DATASET_NAMES[0]
...
def get_hyper(hyper):
  ...
  return hyper.product([
      hyper.sweep('config.dataset_configs.dataset', DATASET_NAMES),
