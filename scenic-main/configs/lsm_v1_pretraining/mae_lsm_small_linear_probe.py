...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_small_linear_probe.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_small_10x5res_linear_probe \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_small_linear_probe.py:runlocal
"""
