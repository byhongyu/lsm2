...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_small.py \
--platform=vlp_4x4 \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_small.py:runlocal
"""
