r"""A config to train a Extra Small ViT MAE on LSM dataset.
...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_extrasmall.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_tier2_extra_small_10_5_res \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_extrasmall.py:runlocal
"""
