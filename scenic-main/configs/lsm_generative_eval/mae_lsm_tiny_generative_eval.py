r"""A config to run geneative evaluation a Tiny ViT MAE on LSM dataset.
...
--config=experimental/largesensormodels/scenic/configs/lsm_generative_eval/mae_lsm_tiny_generative_eval.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_tier2_tiny_10_5_res_generative_task_eval \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/lsm_generative_eval/mae_lsm_tiny_generative_eval.py:runlocal
"""
