...
--config=experimental/largesensormodels/scenic/configs/classification_baselines/supervised_lsm_vit.py \
--platform=vlp_2x2 \
--exp_name=lsm_supervised_tier2_vit_base \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/classification_baselines/supervised_lsm_vit.py:runlocal
"""
...
def get_config(runlocal=''):
  ...
  config.batch_size = 8 if runlocal else BATCH_SIZE[0]
