"""Utils for loading and processing SensorLM data."""
...
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import constants as sensorlm_constants
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import experiment_constants
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import sensor_constants
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import sensors_caption
    ...
    for name, data in df_grouped:
      ...
      if signal == 'BREAK':
        ...
        if (
          ...
          yield name, {
              sensorlm_constants.TFExampleKey.INPUT.value: data,
              sensorlm_constants.TFExampleKey.MASK.value: nan_mask,
              sensorlm_constants.TFExampleKey.MISSINGNESS_RATIO.value: float(
                  missingness_ratio
              ),
              sensorlm_constants.TFExampleKey.USER_ID.value: user_id,
              sensorlm_constants.TFExampleKey.KEY.value: str(name),
              sensorlm_constants.TFExampleKey.CAPTION.value: (
