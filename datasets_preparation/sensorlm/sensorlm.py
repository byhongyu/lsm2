...
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import constants
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import experiment_constants
from google3.medical.waveforms.modelling.lsm.datasets.sensorlm import sensors
from google3.pyglib import gfile


_DESCRIPTION = """SensorLM Tier 2 Dataset / V2"""

_CITATION = """SensorLM Tier 2 Dataset"""
...
class Sensorlm(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(
    ...
    with gfile.Open(experiment_constants.ID_CSV_FP, 'r') as f:
      ids = pd.read_csv(f)['session_id']
    if experiment_constants.NUMBER_OF_SESSIONS != -1:
      ids = ids[: experiment_constants.NUMBER_OF_SESSIONS]
