"""Constants for Sensor Data in LSM and related projects."""
...
FEATURE_TO_SENSOR_DICT = {
    'HR': 'PPG',
    'eda_level_real': 'EDA',
    'leads_contact_counts': 'EDA',
    'steps': 'ACCEL',
    'jerk_auto': 'ACCEL',
    'log_energy': 'ACCEL',
    'covariance': 'ACCEL',
    'log_energy_ratio': 'ACCEL',
    'zero_crossing_std': 'ACCEL',
    'zero_crossing_avg': 'ACCEL',
    'axis_mean': 'ACCEL',
    'altim_std': 'ACCEL',
    'kurtosis': 'ACCEL',
    'sleep_coefficient': 'ACCEL',
    'wrist_temperatures': 'TEMP',
    'hrv_shannon_entropy_rr': 'PPG',
    'hrv_shannon_entropy_rrd': 'PPG',
    'ceda_slope_real_micro_siemens': 'EDA',
    'rmssd_percentile_0595': 'PPG',
    'sdnn_percentile_0595': 'PPG',
    'hrv_percent_good': 'PPG',
    'hrv_rr_80th_percentile_mean': 'PPG',
    'hrv_rr_20th_percentile_mean': 'PPG',
    'hrv_rr_median': 'PPG',
    'hr_at_rest_mean': 'PPG',
    'skin_temperature_slope': 'TEMP'
}
