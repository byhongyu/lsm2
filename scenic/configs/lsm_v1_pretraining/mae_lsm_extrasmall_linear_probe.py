...
Forked from google3/third_party/py/scenic/projects/multimask/configs/mae_cifar10_extrasmall.py

To run on XManager:
gxm third_party/py/scenic/google/xm/launch_xm.py -- \
--binary //experimental/largesensormodels/scenic:main \
--config=experimental/largesensormodels/scenic/configs/mae_lsm_extrasmall_linear_probe.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_extrasmall_10x5res_linear_probe \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_extrasmall_linear_probe.py:runlocal
"""
