r"""A config to train a Huge ViT MAE on LSM dataset.
...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_huge.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_tier2_huge_10_5_res \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_huge.py:runlocal
"""
