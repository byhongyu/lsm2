r"""A config to train a Deb ViT MAE on LSM dataset.
...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_deb.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_tier2_deb_10_5_res \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_deb.py:runlocal
"""
