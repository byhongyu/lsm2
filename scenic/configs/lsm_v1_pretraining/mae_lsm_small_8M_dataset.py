...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_small_8M_dataset.py \
--platform=vlp_4x4 \
--exp_name=lsm_mae_tier2_small_10_5_res_8M_dataset \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_small_8M_dataset.py:runlocal
"""
...
def get_config(runlocal=''):
  ...
  config.dataset_configs.train_split = 'train[:64]' if runlocal else 'train'
