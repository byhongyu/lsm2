r"""A config to train a Large ViT MAE on LSM dataset.
...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_large.py \
--platform=vlp_8x8 \
--exp_name=lsm_mae_tier2_large_10_5_res \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_large.py:runlocal
"""
