...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_base_linear_probe.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_base_10x5res_linear_probe \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_base_linear_probe.py:runlocal
"""
...
LINEAR_DROPOUT = [0.1, 0.3, 0.5, 0.7]
