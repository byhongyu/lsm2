...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_base_mask_ratio_sweep.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_tier2_base_10_5_res_mask_ratio_sweep \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_base_mask_ratio_sweep.py:runlocal
"""
...
VARIANT = 'B/10/5'
TOKEN_MASK_PROBS = [
    'constant_0.3', 'constant_0.4', 'constant_0.5', 'constant_0.6',
    'constant_0.7', 'constant_0.8', 'constant_0.9',

    'constant_0.3_bar', 'constant_0.4_bar', 'constant_0.5_bar',
    'constant_0.6_bar', 'constant_0.7_bar', 'constant_0.8_bar',
    'constant_0.9_bar',

    'constant_0.3_bar_w', 'constant_0.4_bar_w', 'constant_0.5_bar_w',
    'constant_0.7_bar_w', 'constant_0.9_bar_w',
]
