...
--config=experimental/largesensormodels/scenic/configs/mae_lsm_base_8M_combined_pretrain.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_tier2_base_10_5_res_8M_combined_pretrain \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_lsm_base_8M_combined_pretrain.py:runlocal
"""
...
CACHE_DATASET = True
TRAIN_DATA_SIZES = [3000000, 7867175]
