...
Forked from google3/third_party/py/scenic/projects/multimask/configs/mae_cifar10_large.py

To run on XManager:
gxm third_party/py/scenic/google/xm/launch_xm.py -- \
--binary //third_party/py/scenic/projects/multimask:main \
--config=experimental/largesensormodels/scenic/configs/mae_cifar10_large.py \
--platform=vlp_4x4 \
--exp_name=mm_mae_cifar10_large16_64res_test1 \
...
--uptc="" \
--binary=//third_party/py/scenic/projects/multimask:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/mae_cifar10_large.py:runlocal
"""
# pylint: disable=line-too-long
...
def get_config(runlocal=''):
  ...
  config.experiment_name = 'cifar10-mae-vit-large'
  # Dataset.
