...
--config=experimental/largesensormodels/scenic/configs/lsm_generative_eval/mae_lsm_base_generative_eval.py \
--platform=vlp_4x8 \
--exp_name=lsm_mae_tier2_base_10_5_res_generative_task_eval \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/lsm_generative_eval/mae_lsm_base_generative_eval.py:runlocal
"""
...
# 10, 20, 30, 60, 120 min horizons
# 5, 10, 15 sensors masked
SENSOR_IMPUTATION_HORIZONS = [
