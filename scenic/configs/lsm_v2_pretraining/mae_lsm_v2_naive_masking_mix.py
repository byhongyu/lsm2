...
--config=experimental/largesensormodels/scenic/configs/lsm_v2_pretraining/mae_lsm_v2_naive_masking_mix.py \
--platform=glp_8x16 \
--exp_name=MAE_LSM_V2_naive_masking_mix \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/lsm_v2_pretraining/mae_lsm_v2_naive_masking_mix.py:runlocal
"""
