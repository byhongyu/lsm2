...
--config=experimental/largesensormodels/scenic/configs/fewshot_experiments/supervised_fewshot_vit.py \
--platform=vlp_1x1 \
--exp_name=lsm_mae_base_10x5res_fewshot_supervised_vit \
...
--uptc="" \
--binary=//experimental/largesensormodels/scenic:main \
--config=$(pwd)/experimental/largesensormodels/scenic/configs/fewshot_experiments/supervised_fewshot_vit.py:runlocal
"""
...
# FEWSHOT SAMPLES PER CLASS
SAMPLES_PER_CLASS = 5  # 1, 5, 10, 15, 20
NUM_TRAIN_STEPS = 240  # 48, 240, 480, 720, 960
...
def get_config(runlocal=''):
  ...
  config.experiment_name = f'fewshot_lsm_supervised_vit-{DATASET_NAME}'
  ...
  config.batch_size = 8 if runlocal else BATCH_SIZES[0]
