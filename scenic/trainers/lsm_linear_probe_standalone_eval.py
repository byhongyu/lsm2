...
from google3.experimental.largesensormodels.scenic.trainers import lsm_linear_probe_standalone_trainer
...
def linear_probe_evaluate(
  ...
  lp_model = lsm_linear_probe_standalone_trainer.LinearProbingModel(
